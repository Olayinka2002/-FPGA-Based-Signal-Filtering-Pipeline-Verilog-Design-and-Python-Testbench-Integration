...
#
# Generated by Vivado on Thu May 08 14:20:15 -0700 2025
...
#
#    "C:/Users/Olayi/ECE_526_Design_Filter/TOP/TOP.srcs/sources_1/new/top.v"
#    "C:/Users/Olayi/ECE_526_Design_Filter/TOP/TOP.srcs/sim_1/new/top_tb.v"
#
# 3. The following remote source files that were added to the original project:-
#
#    "C:/Users/Olayi/ECE_526_Design_Filter/Sampling/Sampling.srcs/sources_1/new/Sample.v"
#    "C:/Users/Olayi/ECE_526_Design_Filter/IIR_Filter/IIR_Filter.srcs/sources_1/new/simple_IIR_Filter.v"
#    "C:/Users/Olayi/ECE_526_Design_Filter/test_signal.mem"
#    "C:/Users/Olayi/ECE_526_Design_Filter/test_signal_t.mem"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/TOP/TOP.srcs/sources_1/new/top.v"]"\
 "[file normalize "$origin_dir/TOP/TOP.srcs/sim_1/new/top_tb.v"]"\
  ]
  foreach ifile $files {
  ...
  set files [list \
 "[file normalize "$origin_dir/Sampling/Sampling.srcs/sources_1/new/Sample.v"]"\
 "[file normalize "$origin_dir/IIR_Filter/IIR_Filter.srcs/sources_1/new/simple_IIR_Filter.v"]"\
 "[file normalize "$origin_dir/test_signal.mem"]"\
 "[file normalize "$origin_dir/test_signal_t.mem"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set file "$origin_dir/Sampling/Sampling.srcs/sources_1/new/Sample.v"
...
set file "$origin_dir/IIR_Filter/IIR_Filter.srcs/sources_1/new/simple_IIR_Filter.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/test_signal.mem"
set file [file normalize $file]
...
set file "$origin_dir/test_signal_t.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Memory File" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7vx485tffg1157-1 -flow {Vivado Synthesis 2024} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7vx485tffg1157-1 -flow {Vivado Implementation 2024} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
